        ...
        <div class="page-header-top">
            ...
            <nav>
                <ul class="nav justify-content-end header-sett">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../JSP/title.jsp">На главную</a>
                    </li>
                    <li class="nav-item">
...
<div class="page-content">
    <div class="middle-block">
        <div class="info-block">
            <h5>Для модификации, введите новые значения и нажмите "Применить".</h5>
        </div>
        <div class="form-modification">
            <form action="/modifyStudent" method="post">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="sur_name" required value="${student.sur_name}">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="group" required value="${student.group}">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="input_date">Дата поступления</label>
                    <div class="col-sm-10">
                        <input type="date" class="form-control" name="date_in" required value="${student.date_in}">
                    </div>
                </div>
                <button type="submit" class="btn btn-primary dev-button dev-button-creat">Применить</button>
                <button type="submit" class="btn btn-primary dev-button"><a href="../JSP/student">Назад</a></button>
            </form>
        </div>
    </div>
</div>
